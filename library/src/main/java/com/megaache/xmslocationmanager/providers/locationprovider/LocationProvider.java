...
public abstract class LocationProvider {
    ...
    /**
     * This method is called immediately once the LocationProvider is set to {@linkplain XMSLocationManager}
     */
    @CallSuper
    public void configure(ContextProcessor contextProcessor, XMSLocationConfiguration configuration,
    ...
    protected XMSLocationConfiguration getConfiguration() {
