...
@IntDef({FailType.UNKNOWN, FailType.TIMEOUT, FailType.PERMISSION_DENIED, FailType.NETWORK_NOT_AVAILABLE,
      FailType.XMS_NOT_AVAILABLE,
      FailType.XMS_SETTINGS_DIALOG, FailType.XMS_SETTINGS_DENIED,
...
public @interface FailType {
    ...
    int XMS_NOT_AVAILABLE = 4;
    int XMS_SETTINGS_DIALOG = 6;
    int XMS_SETTINGS_DENIED = 7;
    int VIEW_DETACHED = 8;
