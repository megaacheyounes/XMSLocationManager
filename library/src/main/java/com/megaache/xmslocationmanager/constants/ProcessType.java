...
@IntDef({ProcessType.ASKING_PERMISSIONS, ProcessType.GETTING_LOCATION_FROM_XMS,
...
public @interface ProcessType {
    ...
    /**
     * This type will be emitted when XMS is available on device and possible to ask for location update,
     * otherwise it will not be emitted.
     */
    int GETTING_LOCATION_FROM_XMS = 2;
