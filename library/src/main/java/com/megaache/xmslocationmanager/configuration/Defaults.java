...
public final class Defaults {
   ...
   private static final int LOCATION_PRIORITY = XMSLocationRequest.PRIORITY_HIGH_ACCURACY;
    private static final int LOCATION_FASTEST_INTERVAL = MINUTE;


    public static XMSLocationRequest createDefaultLocationRequest() {
        return XMSLocationRequest.create()
