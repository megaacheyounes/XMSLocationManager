...
import com.megaache.xmslocationmanager.constants.ProviderType;
import com.megaache.xmslocationmanager.helper.StringUtils;
import com.megaache.xmslocationmanager.providers.dialogprovider.DialogProvider;
...
public class DefaultProviderConfiguration {
    ...
    public static class Builder {
         ...
         * {@linkplain XMSLocationConfiguration#keepTracking()} is set to true.
        ...
        public Builder setWaitPeriod(@ProviderType int providerType, long milliseconds) {
            ...
            switch (providerType) {
                case ProviderType.XMS: {
                    throw new IllegalStateException("XMS waiting time period should be set on "
                          + "XMSConfiguration");
                }
