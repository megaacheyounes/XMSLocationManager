...
import com.megaache.xmslocationmanager.fakes.MockDialogProvider;
...
public class DefaultProviderConfigurationTest {
    ...
    @Test public void setWaitPeriodShouldThrowExceptionWhenXMSWaitPeriodIsSet() {
        ...
        expectedException.expectMessage(CoreMatchers.startsWith("XMS"));

        new DefaultProviderConfiguration.Builder().setWaitPeriod(ProviderType.XMS, 1);
    }
