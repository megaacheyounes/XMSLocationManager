...
public class SamplePresenter {
    ...
    public void onLocationFailed(@FailType int failType) {
        ...
        switch (failType) {
            ...
            case FailType.XMS_NOT_AVAILABLE: {
                sampleView.setText("Couldn't get location, because Google/Huawei Play Services not available!");
                break;
            }
            case FailType.XMS_SETTINGS_DIALOG: {
                sampleView.setText("Couldn't display settingsApi dialog!");
                break;
            }
            case FailType.XMS_SETTINGS_DENIED: {
    ...
    public void onProcessTypeChanged(@ProcessType int newProcess) {
        switch (newProcess) {
            case ProcessType.GETTING_LOCATION_FROM_XMS: {
                sampleView.updateProgress("Getting Location from Google/Huawei Play Services...");
                break;
            }
